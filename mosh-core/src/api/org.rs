...
pub fn leave_org(org_pubkey: String) -> Result<(), String> {
    todo!("org-cross-runtime: implement org_leave (org + private_group singletons)")
}
...
pub fn send_dm_offer(
    ...
    todo!("org-cross-runtime: implement org_send_dm_offer (org + private_dm singletons)")
}
...
pub fn accept_dm_offer(
    ...
    todo!("org-cross-runtime: implement org_accept_dm_offer (org + private_dm singletons)")
}
...
pub fn create_group(
    ...
    todo!("org-cross-runtime: implement org_create_group (org + private_group singletons)")
}
...
pub fn accept_group_offer(
    ...
    todo!("org-cross-runtime: implement org_accept_group_offer (org + private_group singletons)")
}
...
pub fn group_invite_members(
    ...
    todo!("org-cross-runtime: implement org_group_invite_members (org + private_group singletons)")
}
