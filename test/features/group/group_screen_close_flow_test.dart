...
// `Leave group`) before the real `_leave` (gateway.closeGroup + nav back)
...
//   3. Confirming calls the real `_leave` -> `closeGroup(groupId: ...)`.
//   4. Cancelling does NOT call `_leave` (no gateway closeGroup call).
