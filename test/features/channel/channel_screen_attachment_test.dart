...
ChannelMessage _msgWithAttachment({
...
void main() {
  ...
  testWidgets(
      'offered peer channel attachment renders the AttachmentCard file name',
      (tester) async {
    ...
    await _pump(tester, name: name, snapshot: snapshot);
  ...
  testWidgets(
      'peer channel attachment with no matching view still renders the card',
      (tester) async {
    final descriptor = _fileDescriptor(
      attachmentId: 'att-2',
      fileName: 'photo.jpg',
  ...
  testWidgets('channel offered download disables during the real transfer',
      (tester) async {
    final descriptor = _fileDescriptor(
  ...
  testWidgets('available non-media channel attachment opens externally',
      (tester) async {
    final descriptor = _fileDescriptor(
  ...
  testWidgets('empty local path keeps channel Open disabled', (tester) async {
    final descriptor = _fileDescriptor(
