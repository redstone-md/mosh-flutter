        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // (Rust `private_group_retry_message` + frb codegen + Gateway
              ...
              if (own &&
                ...
                // `private_group_retry_message`, src-tauri/src/lib.rs L922)
                // once the Flutter Gateway ports it. No-op stub for the
