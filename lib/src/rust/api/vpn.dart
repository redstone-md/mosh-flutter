...
class VpnDetection {
  ...
  const VpnDetection({
    required this.vpnLikely,
    required this.suspectInterfaces,
    required this.vpnOwnsDefaultRoute,
  });

  @override
  int get hashCode =>
      vpnLikely.hashCode ^
      suspectInterfaces.hashCode ^
      vpnOwnsDefaultRoute.hashCode;
  ...
  bool operator ==(Object other) =>
      ...
      other is VpnDetection &&
          ...
          vpnLikely == other.vpnLikely &&
          suspectInterfaces == other.suspectInterfaces &&
          vpnOwnsDefaultRoute == other.vpnOwnsDefaultRoute;
}
